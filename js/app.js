(() => {
    ...
    function initSliders() {
        if (document.querySelector(".projects__slider") && document.querySelector(".projects__text-slider")) {
            const swiperParents = document.querySelectorAll(".projects");
            swiperParents.forEach((parent => {
                const projectImageSlider = parent.querySelector(".projects__slider");
                const projectTextSlider = parent.querySelector(".projects__text-slider");
                const sliderProjectImage = new Swiper(projectImageSlider, {
                ...
                const sliderProjectText = new Swiper(projectTextSlider, {
        ...
        resizableSwiper("(min-width: 649.98px)", ".portfolio__slider", sliderSettings);
    ...
    document.addEventListener("windowScroll", (function(e) {
        const scrollTop = window.scrollY;
        if (scrollTop >= 500) document.querySelector(".menu__actions").classList.add("_menu-actions-show"); else document.querySelector(".menu__actions").classList.remove("_menu-actions-show");
    }));
    document.addEventListener("click", (e => {
        const targetElement = e.target;
        if (targetElement.closest(".portfolio__list")) {
            removeClasses(document.querySelectorAll(".portfolio__grid.active"), "active");
            targetElement.closest(".portfolio").classList.remove("grid-item");
            targetElement.closest(".portfolio__list").classList.add("active");
        }
        if (targetElement.closest(".portfolio__grid")) {
            removeClasses(document.querySelectorAll(".portfolio__list.active"), "active");
            targetElement.closest(".portfolio__grid").classList.add("active");
            targetElement.closest(".portfolio").classList.add("grid-item");
        }
    }));
